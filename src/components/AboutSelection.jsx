            ...
            <div className="gradient-border p-6 card-hover">
              <div className="flex items-start gap-4">
                ...
                <div className="text-left">
                  <h4 className="font-semibold text-lg">Backend & Microservices</h4>
                  <p className="text-muted-foreground">
                  Designing scalable backend systems using Node.js, Fastify, MongoDB, Cassandra, Redis, and RabbitMQ (RPC communication).
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-start gap-4">
                <div className="p-3 rounded-full bg-primary/10">
                  <User className="h-6 w-6 text-primary" />
                              ...
                              <div className="text-left">
                  <h4 className="font-semibold text-lg">Smart Home & IoT Integration</h4>
                  <p className="text-muted-foreground">
                  Building voice-enabled smart home solutions and IoT automation using MQTT, EMQX, and Alexa Smart Home skills.
                  </p>
                </div>
              </div>
            </div>
